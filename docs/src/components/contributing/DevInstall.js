  ...
  render() {
    return (
      <div className="dev-install">
        <h2 className="mume-header" id="dev-install">
          Developer Install
        </h2>
        <p>
          To contribute directly, follow the instructions to install for
          development.
        </p>
        <p>
        ...
        <p>
          Install repository development dependencies and scripts
          <p>
