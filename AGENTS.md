...
- **`emulator.screenshot()` is BGR; color histograms and RGB pixel constants expect RGB.** Convert at the boundary (`card_detection._screenshot_rgb`, `state_detect` flips channels). Regression: `tests/test_card_fingerprint_rgb.py`.
