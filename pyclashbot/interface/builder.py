...
def build_stats_section(stats: list[StatConfig], title: str) -> sg.Frame:
    ...
    layout = [
        [
            sg.Column(titles, element_justification="right", pad=(0, 5)),
            sg.Column(values, element_justification="left", pad=(5, 5)),
        ]
    ]
...
def build_emulator_settings_tabs() -> sg.TabGroup:
    """Build tabbed emulator settings with Memu and Google Play tabs."""
    memu_tab = sg.Tab(
        "Memu Settings",
